    ...
    public SecurityFilterChain jwtFilterChain(HttpSecurity http) throws Exception {
        http.securityMatcher("/api/**")
            ...
            .authorizeHttpRequests(requests -> requests
                ...
                .requestMatchers("/api/barang/viewall").hasAnyAuthority("direktur", "general_manager", "kepala_gudang", "sales", "admin", "komisaris")
                .requestMatchers("/api/barang/{id}").hasAnyAuthority("direktur", "general_manager", "kepala_gudang", "sales", "admin", "komisaris")
                .requestMatchers("/api/transfer").hasAnyAuthority("direktur", "general_manager", "kepala_gudang", "admin")
